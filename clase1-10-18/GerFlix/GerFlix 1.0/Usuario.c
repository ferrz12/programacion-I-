...
{
    printf("%d--%s--%d--%d\n", unUsuario.idUsuario, unUsuario.nombre, unUsuario.idSerie, unUsuario.estado);
}
...
void mostrarUsuarioConSuSerie(eUsuario usuarios[], int tamUsuario, eSerie series[], int tamSerie)
{
    ...
    {
        mostrarUsuario(usuarios[i]);
        indiceSerie = retornarIndiceSerieInt(series, tamSerie, idSerie);
        mostrarSerie(series[indiceSerie]);
    }
}


int RetornarIndiceUsuario(eUsuario usuarios[], int tam, eUsuario unUsuario){
